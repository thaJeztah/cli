...
func newInitCommand(dockerCli command.Cli) *cobra.Command {
	...
	flags.IPNetSliceVar(&opts.defaultAddrPools, flagDefaultAddrPool, []net.IPNet{}, "Default subnet address")
	flags.SetAnnotation(flagDefaultAddrPool, "version", []string{"1.39"})
	flags.Uint32Var(&opts.defaultAddrPoolSize, flagDefaultAddrPoolSize, 24, "Default address pool subnet size")
	flags.SetAnnotation(flagDefaultAddrPoolSize, "version", []string{"1.39"})
...
func runInit(dockerCli command.Cli, flags *pflag.FlagSet, opts initOptions) error {
	...
	req := swarm.InitRequest{
		...
		SubnetSize:       opts.defaultAddrPoolSize,
	}
