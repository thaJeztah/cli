...
func runHooks(ctx context.Context, dockerCli ConfigProvider, rootCmd, subCommand *cobra.Command, invokedCommand string, flags map[string]string, cmdErrorMessage string) {
...
func invokeAndCollectHooks(ctx context.Context, dockerCli ConfigProvider, rootCmd, subCmd *cobra.Command, subCmdStr string, flags map[string]string, cmdErrorMessage string) []string {
